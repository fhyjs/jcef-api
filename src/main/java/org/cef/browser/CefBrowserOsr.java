...
public class CefBrowserOsr extends CefBrowser_N implements CefRenderHandler {
    ...
    protected GLCanvas canvas_;
    protected long window_handle_ = 0;
    protected boolean justCreated_ = false;
    ...
    protected boolean isTransparent_;

    protected CopyOnWriteArrayList<Consumer<CefPaintEvent>> onPaintListeners =
    ...
    protected synchronized long getWindowHandle() {
        if (window_handle_ == 0) {
    ...
    protected void createGLCanvas() {
        ...
        canvas_ = new GLCanvas(glcapabilities) {
            protected Method scaleFactorAccessor = null;
            protected boolean removed_ = true;
    ...
    protected static final class SyntheticDragGestureRecognizer extends DragGestureRecognizer {
    ...
    protected static int getDndAction(int mask) {
