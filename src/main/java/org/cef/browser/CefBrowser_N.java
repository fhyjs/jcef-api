...
public abstract class CefBrowser_N extends CefNativeAdapter implements CefBrowser {
    protected volatile boolean isPending_ = false;
    protected final CefClient client_;
    protected final String url_;
    protected final CefRequestContext request_context_;
    protected volatile CefBrowser_N parent_ = null;
    protected volatile Point inspectAt_ = null;
    protected volatile CefDevToolsClient devToolsClient_ = null;
    protected boolean closeAllowed_ = false;
    protected volatile boolean isClosed_ = false;
    protected volatile boolean isClosing_ = false;
    protected final CefBrowserSettings settings_;
